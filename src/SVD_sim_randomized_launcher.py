...
pepper_base_poses = [ # x y z roll pitch
    # [0.2, -0.5, 0.5, 0.0, 0.0],
    # [0.5, -0.6, 0.4, 0.0, 0.0],
    # [0.35, -0.55, 0.65, 0.0, 0.0],
    # [0.9, 0.25, 0.4, 0.0, 0.0]
]
...
def randomize_pepper(pepper_base_pose):
    ...
    roll = round(random.uniform(pepper_base_pose[3] - 0.05, pepper_base_pose[3] + 0.05), 2)
    pitch = round(random.uniform(pepper_base_pose[4] - 0.05, pepper_base_pose[4] + 0.05), 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--roll', type=float, default=0.0, help='Roll angle of pose')
    parser.add_argument('--pitch', type=float, default=0.0, help='Pitch angle of pose')

    args = parser.parse_args()

    pose = [args.x, args.y, args.z, args.roll, args.pitch]
